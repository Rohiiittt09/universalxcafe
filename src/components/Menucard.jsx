...
const Menucard = (prom) => {
  ...
  return (
    <div className=' flex m-0 justify-around border-3 border-[rgb(67,35,11)] sm:p-2 rounded-2xl bg-black/54 cursor-pointer w-30 h-40 sm:h-90 sm:w-50 lg:h-90 lg:w-60 '>
